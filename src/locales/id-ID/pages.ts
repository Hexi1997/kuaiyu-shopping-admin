export default {
  ...
  'pages.login.email.placeholder': 'nama pengguna: admin atau user',
  'pages.login.email.required': 'Nama pengguna harus diisi!',
  'pages.login.password.placeholder': 'kata sandi:123123',
